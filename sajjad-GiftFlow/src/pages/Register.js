        ...
        <div className="card-body">
          ...
          <div>
            <div className="btn btn-primary google-login-button">
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1" x="0px" y="0px" className="google-icon" viewBox="0 0 48 48" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">
